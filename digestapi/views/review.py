...
from digestapi.models import UserBookReview, Book
...
class ReviewViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        # Get all reviews
        reviews = UserBookReview.objects.all()
